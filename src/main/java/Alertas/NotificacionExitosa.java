 ...
 * @author HOME
 */
public class NotificacionExitosa {
    public void NotificacionExitosa(String titulo,String cabecera,String cuerpo)
    {
        Alert alerta=new Alert(Alert.AlertType.CONFIRMATION); //CREAMOS UN NUEVO OBJETO ALERT
